package com.example.TrackEvent.DTO;

public class OrgaDTO {
        private long id;
        ...
        // Constructor
        public OrgaDTO(long id, String pseudo, String mail, String entreprise, long id_event, long avis, String description, String reseaux, byte[] affiche, byte[] pdp) {
            this.id = id;
            this.pseudo = pseudo;
            this.mail = mail;
            this.entreprise = entreprise;
